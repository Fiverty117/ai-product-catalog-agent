...
from app.services.catalog_rendering import CATALOG_RENDER_JOB_TYPE_V2, CATALOG_RENDER_JOB_TYPE_V3, CATALOG_RENDER_JOB_TYPE_V4
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run the local catalog.render.v2/v3/v4 durable-job worker."
    )
...
def main() -> None:
    ...
    worker = JobWorker(
        ...
        accepted_job_types={CATALOG_RENDER_JOB_TYPE_V2, CATALOG_RENDER_JOB_TYPE_V3, CATALOG_RENDER_JOB_TYPE_V4},
    )
    try:
